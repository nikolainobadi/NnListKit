...
//                 line: UInt = #line) -> (sut: GenericListManager<TestItem>, alerts: MockNnListManagerAlerts, remote: NnListRemoteAPISpy) {
//        
...
//                                        cache: cache)
//        
//        let sut = GenericListManager<TestItem>(
...
//        }
//        
//        func makeRemote() -> ooldNnListRemoteAPI<TestItem> {
